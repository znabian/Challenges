    ...
    @section('content')   
        ...
        <div class="col-12 overflow-x-hidden overflow-y px-3 position-relative" style="height: 74vh">
          ...
          <div class="position-relative pt-5  z-1">
            <small>جلسه آفلاین فرست کلاس</small>
          ...
          <div class="position-relative ChallFile  z-1 px-3">
            ...
            <div class="col-12 d-flex gap-2 justify-content-center mt-3">
              ...
              <div class="col-12 position-relative">
                <video id="videoplayer" poster="{{asset('img/login/pic.png')}}" class="videoRes embed-responsive-16by9 picfile blurEffect col-md-8 col-12" oncontextmenu="return false;"  controlsList="nodownload"  >
          ...
          <div class="position-relative col-12 z-1 mt-4 px-3">
            ...
            <div class="cardChall" >
			  ...
			  این فیلم {{$video['Name']}} جلسات آفلاین فرست کلاسه پس با دقت ببین
