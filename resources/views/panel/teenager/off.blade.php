...
<div id="content2" class="content2 " >   
    ...
    <div class="gap-3 gap-md-4 h-auto justify-content-center row w-100 m-auto">
            <div class="lists">
                ...
                <div class="c-pointer card col-12 mt-2 p-md-3 @if($item['Seen']) bg-success-subtle border border-success @elseif(!is_null($item['Seen']))  bg-warning-subtle border border-warning @endif" onclick="this.classList.remove('selected');location.href='{{route('Offline.show',[$item['Id']])}}'">
