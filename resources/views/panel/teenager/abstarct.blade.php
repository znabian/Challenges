...
<div id="content2" class="content2 " >   
    ...
    <div class="col-md-10 gap-1 justify-content-between mt-2 row ">
                <div id="nokatbtn" class="tabbtn bg-gradient bg-opacity-50 selected c-pointer card col-md-5 col d-flex p-md-3 rounded-3" onclick="showlist('nokat')">
                    <div class=" align-items-center card-body d-flex flex-row-reverse gap-1">
                        <span class="col-10 text-center title">نکات</span>
                        
                        <i class="bg-opacity-50 bg-white fa fa-star p-1 rounded-circle"></i>
    
                            
                    </div>  
                </div>
                <div id="shoqlbtn" class="tabbtn bg-gradient bg-opacity-50  c-pointer card col-md-5 col d-flex p-md-3 rounded-3" onclick="showlist('shoql')">
                    <div class=" align-items-center card-body d-flex flex-row-reverse gap-1">
                        <span class="col-10 text-center title">
                        مشاغل
                        </span>
                        
                        <i class="bg-opacity-50 bg-white fa fa-user p-1 rounded-circle"></i>
            ...
            <div class="shoql lists" style="display:none;">
