...
@endsection
@section('content') 
<div class="mx-5 position-fixed" style="top: -2px;">
<span class="badge bg-danger bg-gradient fs-6 small text-light" style="">ویژه کارشناسان سامانه سرخ</span>
</div>
    <div class="login">
            ...
            <div class="col-12 px-3 ">
                <form method="POST" action="{{ route('sup.login') }}" id="frm">
                    @csrf
