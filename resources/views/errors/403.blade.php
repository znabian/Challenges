...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>چالش فرست کلاس-دسترسی مسدود شد</title>
    ...
    <body class="antialiased overflow-hidden">
        <div class="container"  id="content" >
            ...
            <div class="content2 d-flex flex-column gap-3 justify-content-center mt-5"> 
                ...
                <span class="des404">
                    دسترسی به صفحه مورد نظر برای شما بسته شده است. چنانچه توسط لینکی از دیگر صفحات به این خطا رسیده اید، لطفا نشانی آن را به پشتیبان خود اطلاع دهید.
