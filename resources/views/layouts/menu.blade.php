...
@if(\Route::currentRouteName()!="rank.index" && \Route::currentRouteName()!="abstract" && \Route::currentRouteName()!="Offline" && \Route::currentRouteName()!="chat.index" && \Route::currentRouteName()!="direct.index" && !str_contains(\Route::currentRouteName(),"gold"))
